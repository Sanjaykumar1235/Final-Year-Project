...
import {
  ...
  import config, { XappName, modules as xappModules } from './wassenger.config';
...
//   }
    ...
    async createContact(@Body() data: any, @Res() res: Response) {
      ...
      try {
        const result = await this.performwassengerAction('contact', 'create','POST', data);
        return res.status(HttpStatus.OK).json({
    ...
    async createUser(@Body() data: any, @Res() res: Response) {
      ...
      try {
        const result = await this.performwassengerAction('user', 'create','GET', data);
        return res.status(HttpStatus.OK).json({
    ...
    async getChatmessages(@Body() data: any, @Res() res: Response) {
      ...
      try {
        const result = await this.performwassengerAction('chatmessages', 'get','GET', data);
        return res.status(HttpStatus.OK).json({
    ...
    async syncChat(@Body() data: any, @Res() res: Response) {
      ...
      try {
        const result = await this.performwassengerAction('chat', 'sync','GET', data);
        return res.status(HttpStatus.OK).json({
    ...
    async getmanyInvoice(@Body() data: any, @Res() res: Response) {
      ...
      try {
        const result = await this.performwassengerAction('invoice', 'getMany','GET', data);
        return res.status(HttpStatus.OK).json({
    ...
    async createDepartment(@Body() data: any, @Res() res: Response) {
      ...
      try {
        const result = await this.performwassengerAction('department', 'create','GET', data);
        return res.status(HttpStatus.OK).json({
    ...
    async getWebhook(@Body() data: any, @Res() res: Response) {
      ...
      try {
        const result = await this.performwassengerAction('webhook', 'get','GET', data);
        return res.status(HttpStatus.OK).json({
    ...
    async createWebhook(@Body() data: any, @Res() res: Response) {
      ...
      try {
        const result = await this.performwassengerAction('webhook', 'create','GET', data);
        return res.status(HttpStatus.OK).json({
    ...
    async updateWebhook(@Body() data: any, @Res() res: Response) {
      ...
      try {
        const result = await this.performwassengerAction('webhook', 'update','GET', data);
        return res.status(HttpStatus.OK).json({
    ...
    async deleteWebhook(@Body() data: any, @Res() res: Response) {
      ...
      try {
        const result = await this.performwassengerAction('webhook', 'delete','GET', data);
        return res.status(HttpStatus.OK).json({
    ...
    public async initialize(credentialId) {
        try {
          ...
          const apiToken= credentialRepository.auth_data.apiToken
